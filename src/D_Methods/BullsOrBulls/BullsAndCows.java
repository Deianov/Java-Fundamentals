...
public class BullsAndCows extends JFrame implements ActionListener {
    ...
    public void actionPerformed(ActionEvent event) {
        ...
        //check which button the action performed is from
            ...
            //checks to make sure text box is not emty
            if (!temp.equals("")) {
                numOfGuesses++;
                runGuess(temp);
            }
    ...
    // constants and field that we use later.
...
//    Just below our constants and fields, we define a method that set up our app properties to the form. It should contain the following logic:
